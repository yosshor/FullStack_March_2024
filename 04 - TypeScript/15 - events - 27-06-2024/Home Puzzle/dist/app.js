...
function getDivElementForCreature(creature) {
    try {
        ...
        div.onclick = function () { return disappear(creature.name.trim() + 'Id', event); };
        div.id = creature.name.trim() + 'Id';
        // div.style.position = getRandomLocation();
        if (creature.position.top != null)
            div.style.top = creature.position.top;
        if (creature.position.right != null)
            div.style.right = creature.position.right;
        if (creature.position.left != null)
            div.style.left = creature.position.left;
        if (creature.position.bottom != null)
            div.style.bottom = creature.position.bottom;
        ...
        img === null || img === void 0 ? void 0 : img.alt = creature.description;
...
var score = 0;
var level = 1;
console.log(levelId === null || levelId === void 0 ? void 0 : levelId.innerHTML);
console.log(scoreId === null || scoreId === void 0 ? void 0 : scoreId.innerHTML);
function disappear(imgId, event) {
    try {
        ...
        if (element) {
            element.remove();
            score += 1;
            scoreId === null || scoreId === void 0 ? void 0 : scoreId.innerHTML = "Score:" + score;
            if (score % 10 == 0)
                level += 1;
            levelId === null || levelId === void 0 ? void 0 : levelId.innerHTML = "Level:" + level;
            console.log(scoreId === null || scoreId === void 0 ? void 0 : scoreId.innerHTML);
